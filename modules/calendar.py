...
def render_calendar():
    ...
    if mes_selecionado:
        ...
        eventos = {
            ...
            "09-07": {"nome": "Independência do Brasil", "produtos": ["camiseta brasil", "bandeira do brasil", "acessórios verde e amarelo"]},
            "09-15": {"nome": "Dia do Cliente", "produtos": ["cupons", "kits promocionais", "ofertas de beleza"]},
            "09-22": {"nome": "Início da Primavera", "produtos": ["vestido floral", "sandália feminina", "protetor solar"]},
